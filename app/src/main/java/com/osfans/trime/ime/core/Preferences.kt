...
class Preferences(
    ...
    class Keyboard(private val prefs: Preferences) {
        ...
        var inlinePreedit: String = "preview"
    ...
    /**
     *  Wrapper class of input (configuration) preferences.
     */
    class Input(private val prefs: Preferences) {
        companion object {
            ...
            val SDCARD_PATH_PREFIX: String = Environment.getStorageDirectory().path
        }
