...
class TextKeyboardMapper(
    ...
    override fun map(): TextKeyboard {
            ...
            try {
                getList("keys")?.map { node ->
                    ...
                    TextKeyboard.TextKey(
                        ...
                        keyPressOffsetX = it.getFloat("key_press_offset_x"),
                        keyPressOffsetY = it.getFloat("key_press_offset_y"),
        ...
        return TextKeyboard(
            ...
            keyPressOffsetX = getFloat("key_press_offset_x"),
            keyPressOffsetY = getFloat("key_press_offset_y"),
