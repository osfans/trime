...
RIME_VERSION := $(shell cd $(LOCAL_PATH);git describe)
CXX_DEFINES = -DBOOST_NO_CXX11_SCOPED_ENUMS -DRIME_BUILD_SHARED_LIBS -DRIME_EXPORTS -DRIME_VERSION=\"$(RIME_VERSION)\" -DNDEBUG #-DRIME_ENABLE_LOGGING -O3 -fPIC
